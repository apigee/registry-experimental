...
func wipeoutProject(ctx context.Context, registryClient connection.RegistryClient, taskQueue chan<- tasks.Task, project string) {
...
func wipeoutArtifacts(ctx context.Context, registryClient connection.RegistryClient, taskQueue chan<- tasks.Task, parent string) {
...
func wipeoutApiDeployments(ctx context.Context, registryClient connection.RegistryClient, taskQueue chan<- tasks.Task, parent string) {
...
func wipeoutApiSpecs(ctx context.Context, registryClient connection.RegistryClient, taskQueue chan<- tasks.Task, parent string) {
...
func wipeoutApiVersions(ctx context.Context, registryClient connection.RegistryClient, taskQueue chan<- tasks.Task, parent string) {
...
func wipeoutApis(ctx context.Context, registryClient connection.RegistryClient, taskQueue chan<- tasks.Task, parent string) {
