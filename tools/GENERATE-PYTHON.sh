...
python -m grpc_tools.protoc --proto_path=$REGISTRY_PROTOS_PATH --proto_path=$COMMON_PROTOS_PATH --python_out=$PYTHON_TYPES_PATH --grpc_python_out=$PYTHON_TYPES_PATH ${ALL_PROTOS[*]}
