...
class TestClusterWords(unittest.TestCase):
    ...
    with open('/home/gelaw/work-stuff/gocode/src/registry-experimental/consistency/tool/clustering/clustering_test.json', 'r') as f:
        data = json.load(f)

    @parameterized.expand([
        ('simple', {'abandon': ['abandon', 'abandoning'], 'Abort': ['Abort', 'abort', 'aborted'], 
